  ...
  return (
    <div>
      ...
      >
        <div
          className={`
          w-full max-w-[1100px] flex items-center justify-between mt-20 mx-auto
        `}
        >
          ...
          <div className="p-8 bg-gray-700 border border-gray-500 rounded">
            ...
            >
              ...
              <button
                ...
                disabled={loading}
                className={`
                  uppercase mt-4 bg-green-500 py-4 rounded font-bold text-sm
        ...
        <img src={codeMockupImg} alt="code image" className="mt-10" />
      </div>
    </div>
  )
}
